...
sed -i 's|^\s*"terminal.integrated.defaultProfile.linux":\s*.*\(,\?\)|\t"terminal.integrated.defaultProfile.linux": "zsh"\1|' ~/.config/Code/User/settings.json
sed -i 's|^\s*"terminal.integrated.fontFamily":\s*.*\(,\?\)|\t"terminal.integrated.fontFamily": "MesloLGS NF"\1|' ~/.config/Code/User/settings.json
sleep 2;
